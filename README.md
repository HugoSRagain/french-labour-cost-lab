...
```bash
git clone https://github.com/HugoSRagain/french-labour-cost-lab.git
cd french-labour-cost-lab
```

Create and activate a Python environment:

```bash
conda create -n labour-cost-lab python=3.11 -y
conda activate labour-cost-lab
```
...
```bash
python scripts/build_dataset_mon_entreprise.py
```
...
After modifying the configuration, scripts or styles:
...
GitHub Pages will then update the public dashboard after a short delay.
